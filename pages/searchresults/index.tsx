...
export default function Index() {
    ...
    return(
      ...
      <div className=" md:block">
        <h2 className="text-xl xl:text-2xl font-bold mb-4">Search Results</h2>
        <p className="text-sm xl:text-base font-medium">
          <span className=" text-brand-gray-400">showing results for</span> <span className="text-brand-black-400 font-bold">"theshinobi concert"</span>
        </p>
      </div>
      </div>
    ...
    <div className="flex flex-col items-center gap-3">
        <Image 
            ...
            <h1 className="text-black-900 font-bold font-16 text-2xl">Oops, something is missing</h1>
            <p className="items-center text-gray-500">We couldn't find any results for your search. Please check</p>
             <p className="items-center text-gray-500">your entry and try again.</p>
            <Button className="pt-4 pb-4 pl-4 pr-4 bg-pink-400  mt-8  rounded-2xl" href="https://zuri-events-app.vercel.app/timeline">
                <Image
                        alt="vector"
