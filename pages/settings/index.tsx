        ...
        <div className="w-full md:flex gap-8 ">
          <div className="px-4 py-6 md:w-2/5 bg-[#3F3849] rounded-2xl">
            ...
            <div className="mt-4 rounded-[10px] overflow-hidden">
              <div className="p-3.5 flex justify-between items-center bg-[#FFC6BC]">
              ...
              <div className="p-3.5 flex justify-between items-center bg-[#D2F5FE]">
                <div className=" flex items-center gap-2.5">
                  <svg
                    width="24"
                    height="24"
              ...
              <div className="p-3.5 flex justify-between items-center bg-[#FFE0C4]">
                <div className=" flex items-center gap-2.5">
                  <svg
                    width="24"
                    height="24"
              ...
              <div className="p-3.5 flex justify-between items-center bg-[#FFC6BC]">
                <div className=" flex items-center gap-2.5">
                  ...
                  <p className="font-bold text-lg">Language and Region</p>
                </div>
                <svg
                  width="24"
                  height="24"
