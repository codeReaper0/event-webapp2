...
const TimeLineEventCard = ({
  ...
  return (
    <div
      className={`py-6 px-4 rounded-2xl ${renderBg} max-h-[400px] flex flex-col `}
    >
      ...
      <div className="relative mt-4 flex justify-between gap-3 h-1/2">
        <span className="text-black font-sans font-medium text-base">
          ...
          <p className="mt-3 opacity-70">
            {convertDate(created_at).toDateString()}
          </p>
